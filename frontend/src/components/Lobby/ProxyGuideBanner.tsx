    ...
    <div className="proxy-info-banner-simple">
      <div className="proxy-banner-content">
        <div className="proxy-banner-title">
          ...
          OCaml版とRust版のProxyが用意されています。<a href="https://github.com/Taisei-dev/reversi-proxy" target="_blank" rel="noopener noreferrer">GitHub</a>
        </div>
        <div className="proxy-banner-commands">
          <span>• <strong>OCaml Proxy</strong>: <code>dune exec ./proxy.exe -- [-d] &lt;LOCAL_PORT&gt; &lt;接続URL&gt;</code> </span>
